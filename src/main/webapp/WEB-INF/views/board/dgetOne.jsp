    ...
    <div class="container-scroller">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">딥다이빙 로그 수정</h4>
                    <p class="card-description">
                      딥다이빙 로그 수정
                    </p>
                    <form class="forms-sample" action="/controller/board/dmodify" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">리뷰</label>
                        <input type="text" class="form-control" name="num" value="<c:out value='${sdiv.num }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">날짜</label>
                        <input type="text" class="form-control" name="date" value="<c:out value='${sdiv.date }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">포인트 위치</label>
                        <input type="text" class="form-control" name="point" value="<c:out value='${sdiv.point }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">장비</label>
                        <input type="text" class="form-control" name="equipment" value="<c:out value='${sdiv.equipment }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">해양생물</label>
                        <input type="text" class="form-control" name="fish" value="<c:out value='${sdiv.fish }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">리뷰</label>
                        <input type="text" class="form-control" name="review" value="<c:out value='${sdiv.review }'/>">
                      </div>
                      <button type="submit" class="btn btn-primary me-2">Update</button>
                      <button onclick="location.href='/controller/board/dremove';" formmethod="POST" class="btn btn-danger">Delete</button>
...
<script>
	$(document).redy(function(){
		...
		if(oper === 'remove') {
			myform.attr("action", "controller/board/remove").attr("method", "post")
		}
	});
