        ...
        <div class="row">
            ...
            <div class="card-body">
                ...
                <table class="table">
				    ...
				    <tbody>
				         <c:forEach var="sdiv" items="${slist }">
				            <tr>
				                <td>${sdiv.num }</td>
				                <td><a href="/controller/board/getOne?num=<c:out value='${sdiv.num }'/>"><c:out value='${sdiv.date }'/></a></td>
				                <td>${sdiv.point }</td>
  				                <td>${sdiv.equipment }</td>
				                <td>${sdiv.fish }</td>
				                <td>${sdiv.review }</td>
				            </tr>
				        </c:forEach>
                ...
                <button onclick="location.href='/controller/board/register'" type="button" class="btn btn-primary">추가</button>
                </div>
            </div>
        </div>
        </div>
