    ...
    <div class="container-scroller">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">버디 등록하기</h4>
                    <p class="card-description">
                      버디 정보 입력
                    </p>
                    <form class="forms-sample" action="/controller/board/budyregister" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">이름</label>
                        <input type="text" class="form-control" name="name" placeholder="손옥무">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">전화번호</label>
                        <input type="text" class="form-control" name="tell" placeholder="01012341234">
                      </div>
