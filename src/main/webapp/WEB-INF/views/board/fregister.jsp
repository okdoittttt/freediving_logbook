    ...
    <div class="container-scroller">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">펀다이빙 로그 입력</h4>
                    <p class="card-description">
                      펀다이빙 로그 입력
                    </p>
                    <form class="forms-sample" action="/controller/board/fregister" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">날짜</label>
                        <input type="text" class="form-control" name="date" placeholder="11-11">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">포인트 위치</label>
                        <input type="text" class="form-control" name="point" placeholder="부산 해운대 해변">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">장비</label>
                        <input type="text" class="form-control" name="equipment" placeholder="웨이트 5kg, 롱 핀, 3mm 슈트">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">해양생물</label>
                        <input type="text" class="form-control" name="fish" placeholder="용치노래기, 뱅애돔">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">리뷰</label>
                        <input type="text" class="form-control" name="review" placeholder="파도가 강해서 스노쿨링하기 쉽지 않았다.">
                      </div>
