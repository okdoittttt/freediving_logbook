        ...
        <div class="row">
            ...
            <div class="card-body">
                ...
                <table class="table">
				    ...
				    <tbody>
				         <c:forEach var="ddiv" items="${list }">
				            <tr>
				                <td>${ddiv.num }</td>
				                <td><a href="/controller/board/dgetOne?num=<c:out value='${ddiv.num }'/>"><c:out value='${ddiv.date }'/></a></td>
				                <td>${ddiv.point }</td>
  				                <td>${ddiv.equipment }</td>
				                <td>${ddiv.fish }</td>
				                <td>${ddiv.review }</td>
				            </tr>
				        </c:forEach>
                ...
                <button onclick="location.href='/controller/board/dregister'" type="button" class="btn btn-primary">추가</button>
                </div>
            </div>
        </div>
        </div>
