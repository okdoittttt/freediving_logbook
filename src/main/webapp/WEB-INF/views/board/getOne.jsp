    ...
    <div class="container-scroller">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">스노쿨링 로그 입력</h4>
                    <p class="card-description">
                      스노쿨링 로그 입력
                    </p>
                    <form class="forms-sample" action="/controller/board/modify" method="post">
                      ...
                      <button onclick="location.href='/controller/board/remove';" formmethod="POST" class="btn btn-danger">Delete</button>
