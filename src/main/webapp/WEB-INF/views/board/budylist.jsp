        ...
        <div class="row">
            ...
            <div class="card-body">
                ...
                <table class="table">
				    ...
				    <tbody>
				         <c:forEach var="budy" items="${budy }">
				            <tr>
				                <td>${budy.num }</td>
				                <%-- <td><a href="/controller/board/getOne?num=<c:out value='${budy.num }'/>"><c:out value='${budy.name }'/></a></td> --%>
				                <td><a href="/controller/board/budygetOne?num=<c:out value='${budy.num }'/>"><c:out value='${budy.name }'/></a></td>
				                <td>${budy.tell }</td>
				                <td><img src="../resources/img/${budy.filename }"></td>
				                <%-- <td>${budy.filename }</td> --%>
				            </tr>
				        </c:forEach>
				    </tbody>
                </table>
                <button onclick="location.href='/controller/board/budyregister'" type="button" class="btn btn-primary">추가</button>
                </div>
            </div>
        </div>
        </div>
