    ...
    <div class="container-scroller">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">버디</h4>
                    <p class="card-description">
                    	버디 수정
                    </p>
                    <form class="forms-sample" action="/controller/board/budymodify" method="post">
                      <div>
                      	<img src="../resources/img/${budy.filename }" height="280" width="180">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">번호</label>
                        <input type="text" class="form-control" name="num" value="<c:out value='${budy.num }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">이름</label>
                        <input type="text" class="form-control" name="name" value="<c:out value='${budy.name }'/>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">전화번호</label>
                        <input type="text" class="form-control" name="tell" value="<c:out value='${budy.tell }'/>">
                      <button type="submit" class="btn btn-primary me-2">Update</button>
                      <button onclick="location.href='/controller/board/budyremove';" formmethod="POST" class="btn btn-danger">Delete</button>
